...
Vehicle.prototype.print = function() {
  return `I am a Vehicle and my standard speed is ${this.speed} and I am ${this.color}`
}
...
class Vehicle {
  constructor(make, model, speed, fuelAmount, color) {
    this.make = make
    this.model = model
    this.speed = speed
    this.fuelAmount = fuelAmount
...
const vehicle2 = new Vehicle("Mazda", "CX-5", 320, "45L", "black")

class Car extends Vehicle {
  constructor(make, model, speed, fuelAmount, color) {
    super() // we must call super() in the child constructor before using `this`
    this.make = make
    this.model = model
    this.speed = speed
    this.fuelAmount = fuelAmount
...
const car2 = new Car("Nissan", "GT-R", 330, "35L", "grey")
